          ...
          <Table responsive striped hover variant="dark">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <img style={{ width: "30px" }} src={exchange.image} />
                  <span style={{ marginLeft: "5px" }}>{exchange.name}</span>
                </td>
              </tr>
              <tr>
                <th scope="row" className="title">
              ...
              <tr>
                ...
                <td>
                  <a href={exchange.facebook_url} title="facebook icons">
                  ...
                  <a href={exchange.telegram_url} title="facebook icons">
                    <img src={telegramIcon} className="social-media" />
                  </a>
                  <a href={exchange.reddit_url} title="facebook icons">
                    <img src={redditIcon} className="social-media" />
                  </a>
                </td>
              </tr>
              <tr>
